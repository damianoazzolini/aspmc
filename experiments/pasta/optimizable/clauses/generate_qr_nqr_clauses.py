...
echo "instance $i"
time pasta qr_nqr_clauses_{"negated_" if args.negated else ""}{sz}_$i.lp --query="qr" --optimize {"--epsilon=0.06" if eps == 0.06 else ""} --threshold=0.7 --target=upper --verbose --method={alg}
done 
